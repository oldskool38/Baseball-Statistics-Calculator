...
namespace BaseballStatisticsCalculator
{
	...
	{
		private TextBlock [] lblStats = new TextBlock [22];
		...
		public Defense ()
		{
			...
			double txtWidth = 0;
			double lblWidth = 0;
			string [] stat = new string [] { "Assists", "Walks", "Caught Stealing", "Caught Stealing Percentage", "Defensive Efficiency Ratio", "Errors", "Fielding Percentage", "Hits", "Hit By Pitch", "Home Runs", "Innings Played", "Outs", "Plate Appearances", "Putouts", "Range Factor", "Reached On Error", "Stolen Base Attempts", "Strike Outs", "Total Chances", "Wins", "Losses", "Win Percentage" };
