...
{
	/// <summary>
	/// This page will be used to get, display, and update the stored offensive stats
	/// </summary>
	public sealed partial class Offense : Page
	{
		...
		{
			// Get the offense statistics from the database
			SqliteDataReader stats = DataAccess.GetOffenseStats (player);
			...
			txtStats [5].Text = string.Format ("{0:#.000}", stats.GetString (5));
			txtStats [6].Text = string.Format ("{0:#.000}", stats.GetString (6));
			txtStats [7].Text = string.Format ("{0:###0}", stats.GetString (7));
			txtStats [8].Text = string.Format ("{0:##0.0%}", stats.GetString (8));
			txtStats [9].Text = string.Format ("{0:###0}", stats.GetString (9));
			txtStats [10].Text = string.Format ("{0:###0}", stats.GetString (10));
			txtStats [11].Text = string.Format ("{0:###.00}", stats.GetString (11));
			txtStats [12].Text = string.Format ("{0:###0}", stats.GetString (12));
			txtStats [13].Text = string.Format ("{0:###0}", stats.GetString (13));
			txtStats [14].Text = string.Format ("{0:###0}", stats.GetString (14));
			txtStats [15].Text = string.Format ("{0:##0.0%}", stats.GetString (15));
			txtStats [16].Text = string.Format ("{0:###0}", stats.GetString (16));
			txtStats [17].Text = string.Format ("{0:#.000}", stats.GetString (17));
			txtStats [18].Text = string.Format ("{0:#.000}", stats.GetString (18));
			txtStats [19].Text = string.Format ("{0:#.000}", stats.GetString (19));
			txtStats [20].Text = string.Format ("{0:###0}", stats.GetString (20));
			txtStats [21].Text = string.Format ("{0:###.00}", stats.GetString (21));
			txtStats [22].Text = string.Format ("{0:###0}", stats.GetString (22));
			txtStats [23].Text = string.Format ("{0:###0}", stats.GetString (23));
			txtStats [24].Text = string.Format ("{0:###0}", stats.GetString (24));
			...
			txtStats [28].Text = string.Format ("{0:###0}", stats.GetString (28));
			txtStats [29].Text = string.Format ("{0:#.000}", stats.GetString (29));
			txtStats [30].Text = string.Format ("{0:###0}", stats.GetString (30));
			txtStats [31].Text = string.Format ("{0:##0.0%}", stats.GetString (31));
			txtStats [32].Text = string.Format ("{0:###0}", stats.GetString (32));
			txtStats [33].Text = string.Format ("{0:###0}", stats.GetString (33));
			txtStats [34].Text = string.Format ("{0:###0}", stats.GetString (34));
			txtStats [35].Text = string.Format ("{0:##0%}", stats.GetString (35));
		}
